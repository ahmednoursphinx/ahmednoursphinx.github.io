...
# <span style="color: #808000;">Understanding Geometric Sequences</span>

## <span style="color: #808000;">Sequence</span>
A sequence is a set of things, usually numbers, in order. For example: 3, 5, 7, 9, ...

## <span style="color: #808000;">Geometric Sequence</span>
...
## <span style="color: #808000;">General Form</span>
...
## <span style="color: #808000;">Formula for the nth Term</span>
...
## <span style="color: #808000;">Sum of a Geometric Sequence</span>
The sum of the first `n` terms of a geometric sequence is:  

Σ_{k=0}^{n-1} arᵏ = a(1 - rⁿ)/(1 - r)
